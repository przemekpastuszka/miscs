...
{
  // This data describes the problem. For each pair of inputs, the generated
  // program
  // should return the associated output. The goal of this appliction is to
  // generalise
  ...
  public static void main(String[] args)
  {
    ...
    System.out.print(program.print() + " " + program.getDepth());
  }
   ...
   * 
   * @param data
   *          A map from input values to expected output values.
   * @return A program that generates the correct outputs for all specified sets
   *         of input.
   */
  public static Node evolveProgram(Map<double[], Double> data)
  {
    TreeFactory factory = new TreeFactory(2, // Number of parameters passed into
                                             // each program.
        4, // Maximum depth of generated trees.
        Probability.EVENS, // Probability that a node is a function node.
        new Probability(0.6d)); // Probability that other nodes are params
